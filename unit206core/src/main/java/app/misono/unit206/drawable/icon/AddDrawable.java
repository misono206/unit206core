...
@TargetApi(1)
public final class AddDrawable extends SkeletonDrawable {
	private static final String TAG = "AddDrawable";

	private static final ElementPath[] PLUS = {
			new ElementPath(PATH_M, new float[]{19,13}),
	...
	public AddDrawable(int wPixel, int hPixel, int color) {
		super();
